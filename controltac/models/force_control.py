...
class ForceTransformerBlock(nn.Module):
    """
    ...
    def forward(self, x, y, t, HW=None, **kwargs):
        B, N, C = x.shape
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            ffn_type=ffn_type,
            use_pe=use_pe,
            force_norm_scale_factor=force_norm_scale_factor,
        ...
        self.initialize()
    def forward(self, x, timestep, force, mask=None, data_info=None, **kwargs):
        """
        ...
        for block in self.blocks:
            x = block(x, force, t0, (self.h, self.w), **kwargs)
